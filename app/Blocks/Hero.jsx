...
const Hero = () => {
    ...
    <div className='px-4 py-2 flex flex-col items-center w-full sm:my-20 my-15'>
        ...
        <div className="border px-4 rounded-full flex items-center gap-x-1.5 sm:py-[4px] pr-[7px] pl-[11px] border-black/[0.03] bg-[rgba(30,31,37,0.04)] backdrop-blur-[10px] hover:not-active:bg-[rgba(30,31,37,0.08)] text-xs font-medium transition-background duration-150 ease-in-out cursor-pointer">Early stage project requirements <ArrowRight size={13} className='mt-0.5'/>
        </div>
        <div>
            <h1 className="text-gray-700 [font-family:var(--font-geist-mono)] mt-10 max-w-176 text-center sm:text-5xl text-2xl font-bold [word-spacing:0]">
                Magically Simplify <br></br> <div className='sm:mt-4 mt-2'>
