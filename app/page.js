...
export default function Home() {
  ...
  return (
    ...
    [background:radial-gradient(125%_100%_at_50%_0%,_#FFF_6.32%,_#E0F0FF_29.28%,_#E0F0FF_29.28%,_#E7EFFD_68.68%,_#FFF_100%)]">
      ...
      <div className="relative w-full dark:bg-neutral-900">
        <div className="absolute inset-x-0 dark:hidden sm:block hidden w-full h-px bg-gradient-to-r from-neutral-300/50 via-neutral-200 to-neutral-200/50 pointer-events-none"/>
        <div className="max-w-4xl mx-auto sm:p-5 py-2 dark:bg-neutral-900">
        ...
        <div className="flex sm:flex-row flex-col justify-center sm:mt-20 mt-10 sm:px-0 px-6 items-center w-full h-auto dark:bg-neutral-900">
        <div className="items-center max-w-4xl justify-center overflow-hidden [font-family:var(--font-jetbrains)] dark:bg-neutral-900">
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <p className="sm:text-[3.5rem] text-[3rem] w-full font-bold">
              <LineShadowText>SCRIVO</LineShadowText>
            </p>
          </BoxReveal>
    
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <h2 className="mt-[.5rem] sm:text-[1.5rem] text-[1.2rem] font-mono">
              Your Excuse To Look{" "}
              <span className="text-[#5046e6] font-mono font-bold">Busy</span>
            </h2>
          </BoxReveal>
          ...
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <div className="mt-3 sm:text-[15px] text-sm text-justify [font-family:var(--font-geist-sans)]">
              <p>
                ...
                No matter what you are trying to dream up - Scrivo helps you get it done.<br/>
              </p>
            </div>
          </BoxReveal>
      ...
      <div className="sm:mt-15 mt-10 p-10 h-[350px] w-full bg-gray-50 dark:bg-black">
        ...
        <p className="text-gray-700 dark:text-gray-300 sm:text-[15px] text-sm [font-family:var(--font-jetbrains)] text-center mt-3">
